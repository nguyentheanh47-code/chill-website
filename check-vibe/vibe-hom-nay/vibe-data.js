...
var VIBE_CONTENT = {
  ...
  "Lập Xuân": {
    "Bạch Dương": { vutru: "Lập Xuân — mùa Xuân bắt đầu, hành Mộc mới lên thay Thuỷ — đúng chất khởi đầu năng động của Bạch Dương. Đây là lúc khởi động mạnh mẽ nhất năm.", chill: "Đúng gu của em quá rồi! Mùa mới bắt đầu, xông lên khởi động dự định lớn nhất năm đi!" },
    "Kim Ngưu": { vutru: "Lập Xuân — mùa Xuân bắt đầu, hành Mộc mới lên. Kim Ngưu vốn ổn định, đây là lúc gieo hạt cho những kế hoạch dài hơi, không cần hái quả liền.", chill: "Đây là lúc gieo hạt cho kèo dài hơi, đừng vội hái quả liền nha bạn ơi! Chậm mà chắc là có lộc thiệt đó!" },
    "Song Tử": { vutru: "Lập Xuân — mùa Xuân bắt đầu, hành Mộc mới lên. Song Tử vốn năng động, mùa xuân mang tới hàng loạt ý tưởng và cơ hội mới để khám phá.", chill: "Mùa mới, cơ hội mới đang mở ra khắp nơi đó, đầu óc năng động của em chắc đang phấn khích lắm!" },
    "Cự Giải": { vutru: "Lập Xuân — mùa Xuân bắt đầu, hành Mộc mới lên. Cự Giải vốn nhạy cảm, cảm nhận rõ sức sống mới đang trỗi dậy sau mùa đông dài.", chill: "Sau mùa đông dài, giờ là lúc cảm xúc em cũng bừng tỉnh lại rồi đó, đón nhận nguồn năng lượng mới nha!" },
    "Sư Tử": { vutru: "Lập Xuân — mùa Xuân bắt đầu, hành Mộc mới lên, chuẩn bị nuôi dưỡng cho Hoả bùng lên vào mùa hè. Sư Tử vốn rực rỡ, đây là lúc tích luỹ năng lượng.", chill: "Chưa phải lúc bung hết cỡ đâu, tích luỹ dần để giữa năm bùng nổ thật đã nha chiến thần!" },
    "Xử Nữ": { vutru: "Lập Xuân — mùa Xuân bắt đầu, hành Mộc mới lên. Xử Nữ vốn chỉn chu, đây là lúc lập kế hoạch chi tiết cho cả năm sắp tới.", chill: "Đầu năm mới là lúc hợp nhất để lập kế hoạch chi tiết, đúng sở trường của em rồi đó!" },
    "Thiên Bình": { vutru: "Lập Xuân — mùa Xuân bắt đầu, hành Mộc mới lên. Thiên Bình vốn cân bằng, đây là lúc cân đối lại mọi mục tiêu cho năm mới.", chill: "Đặt mục tiêu năm mới thì nhớ cân bằng mọi mặt cuộc sống nha, đừng dồn hết vào 1 thứ!" },
    "Bọ Cạp": { vutru: "Lập Xuân — mùa Xuân bắt đầu, hành Mộc mới lên thay Thuỷ. Bọ Cạp vốn sâu sắc, đây là lúc chuyển hoá những gì đã chiêm nghiệm thành hành động cụ thể.", chill: "Bao suy nghĩ sâu sắc cả mùa đông giờ là lúc biến thành hành động thật rồi đó!" },
    "Nhân Mã": { vutru: "Lập Xuân — mùa Xuân bắt đầu, hành Mộc mới lên. Nhân Mã vốn phóng khoáng, đây là lúc bắt đầu những chuyến phiêu lưu đã lên kế hoạch từ mùa đông.", chill: "Kế hoạch phiêu lưu ấp ủ cả mùa đông giờ là lúc khởi hành rồi đó, lên đường thôi!" },
    "Ma Kết": { vutru: "Lập Xuân — mùa Xuân bắt đầu, hành Mộc mới lên thay Thuỷ. Ma Kết vốn kiên trì, đây là lúc chuyển giao từ mùa đỉnh cao sang giai đoạn củng cố.", chill: "Sau mùa đỉnh cao, giờ là lúc củng cố vững chắc những gì đã đạt được nha!" },
    "Bảo Bình": { vutru: "Lập Xuân — mùa Xuân bắt đầu, vẫn còn dư âm mùa của Bảo Bình. Ý tưởng ấp ủ cả mùa đông giờ đã sẵn sàng bung nở.", chill: "Ý tưởng ấp ủ cả mùa đông giờ đã sẵn sàng rồi đó, bung ra thực hiện thôi!" },
    "Song Ngư": { vutru: "Lập Xuân — mùa Xuân bắt đầu, vẫn còn dư âm mùa của Song Ngư. Trực giác và cảm hứng sáng tạo đang ở giai đoạn cuối cùng của đỉnh cao.", chill: "Vẫn đang phong độ cao đó, tận dụng nốt giai đoạn này trước khi nhường sân cho mùa mới nha!" }
  },
  "Vũ Thuỷ": {
    "Bạch Dương": { vutru: "Vũ Thuỷ — mưa xuân bắt đầu rơi, đất trời ẩm ướt, hành Mộc dần vượng. Bạch Dương vốn nóng vội, cần thêm sự mềm mại như mưa xuân.", chill: "Nóng vội quá đôi khi hỏng việc, mềm mỏng như mưa xuân 1 chút sẽ hiệu quả hơn đó!" },
    "Kim Ngưu": { vutru: "Vũ Thuỷ — mưa xuân bắt đầu rơi, hành Mộc dần vượng. Kim Ngưu vốn thực tế, mưa xuân là điềm lành cho những kế hoạch đang gieo trồng.", chill: "Mưa xuân tưới cho hạt giống em vừa gieo, cứ yên tâm nó đang lớn lên từng ngày đó!" },
    "Song Tử": { vutru: "Vũ Thuỷ — mưa xuân bắt đầu rơi, hành Mộc dần vượng. Song Tử vốn nhanh nhạy, mưa xuân mang tới nguồn cảm hứng mới cho những ý tưởng đang ấp ủ.", chill: "Mưa xuân tưới mát cho não em thêm sáng tạo đó, ý tưởng mới chắc đang tuôn trào!" },
    "Cự Giải": { vutru: "Vũ Thuỷ — mưa xuân bắt đầu rơi, hành Mộc dần vượng — hợp bản chất Cự Giải. Cảm xúc trở nên mềm mại, dễ đồng cảm hơn trong giai đoạn này.", chill: "Trái tim em đang mềm mại như mưa xuân đó, dễ đồng cảm và thấu hiểu người khác hơn hẳn!" },
    "Sư Tử": { vutru: "Vũ Thuỷ — mưa xuân bắt đầu rơi, hành Mộc dần vượng, nuôi dưỡng cho Hoả bùng lên sau này. Sư Tử vốn rực rỡ, đây là lúc âm thầm tích luỹ.", chill: "Mưa xuân đang âm thầm nuôi dưỡng ngọn lửa trong em đó, kiên nhẫn chờ tới lúc bùng cháy nha!" },
    "Xử Nữ": { vutru: "Vũ Thuỷ — mưa xuân bắt đầu rơi, hành Mộc dần vượng. Xử Nữ vốn tỉ mỉ, đây là lúc rà soát lại từng chi tiết trong kế hoạch năm mới.", chill: "Mưa xuân giúp mọi thứ rõ ràng hơn, rà soát lại kế hoạch cho thật chỉn chu nha!" },
    "Thiên Bình": { vutru: "Vũ Thuỷ — mưa xuân bắt đầu rơi, hành Mộc dần vượng. Thiên Bình vốn cân bằng, mưa xuân mang tới sự cân bằng giữa khô hạn mùa đông và ẩm ướt mùa xuân.", chill: "Mọi thứ đang dần cân bằng trở lại rồi đó, tận hưởng cảm giác hài hoà này nha!" },
    "Bọ Cạp": { vutru: "Vũ Thuỷ — mưa xuân bắt đầu rơi, hành Mộc dần vượng thay Thuỷ. Bọ Cạp vốn sâu sắc, mưa xuân giúp gột rửa những gì cũ kỹ, chuẩn bị cho khởi đầu mới.", chill: "Mưa xuân đang gột rửa hết những điều cũ đó, sẵn sàng đón nhận 1 khởi đầu mới tinh nha!" },
    "Nhân Mã": { vutru: "Vũ Thuỷ — mưa xuân bắt đầu rơi, hành Mộc dần vượng. Nhân Mã vốn phóng khoáng, mưa xuân là lúc thích hợp để tiếp tục hành trình đã bắt đầu.", chill: "Hành trình đã khởi động rồi, mưa xuân sẽ tưới mát cho chặng đường phía trước đó!" },
    "Ma Kết": { vutru: "Vũ Thuỷ — mưa xuân bắt đầu rơi, hành Mộc dần vượng thay Thuỷ. Ma Kết vốn kiên trì, đây là lúc thích nghi với nhịp độ mới sau mùa đỉnh cao.", chill: "Nhịp độ đang chuyển dần rồi đó, thích nghi từ từ, không cần vội vàng nha!" },
    "Bảo Bình": { vutru: "Vũ Thuỷ — mưa xuân bắt đầu rơi, hành Mộc dần vượng. Bảo Bình vốn sáng tạo, mưa xuân giúp những ý tưởng độc đáo bắt đầu bén rễ thành hiện thực.", chill: "Ý tưởng độc lạ của em đang bắt đầu bén rễ rồi đó, kiên nhẫn chăm sóc nó nha!" },
    "Song Ngư": { vutru: "Vũ Thuỷ — mưa xuân bắt đầu rơi, hành Mộc dần vượng — rất hợp bản chất Song Ngư. Mưa và nước là nguyên tố quen thuộc, cảm hứng dâng trào.", chill: "Mưa xuân đúng chất element của em rồi đó, cảm hứng chắc đang tuôn trào mạnh lắm!" }
  },
  "Kinh Trập": {
    "Bạch Dương": { vutru: "Kinh Trập — sâu bọ tỉnh giấc, vạn vật cựa mình, hành Mộc bừng lên mạnh mẽ. Bạch Dương vốn năng động, đây là lúc bùng nổ hành động thực sự.", chill: "Tỉnh giấc và hành động thôi, đúng thời điểm để em bung hết năng lượng rồi đó!" },
    "Kim Ngưu": { vutru: "Kinh Trập — sâu bọ tỉnh giấc, Mộc khí bừng lên mạnh mẽ. Kim Ngưu vốn từ tốn, đây là lúc chuyển từ tích luỹ sang hành động cụ thể.", chill: "Đã tích luỹ đủ lâu rồi, giờ là lúc bắt đầu hành động thật sự đó!" },
    "Song Tử": { vutru: "Kinh Trập — sâu bọ tỉnh giấc, Mộc khí bừng lên. Song Tử vốn hoạt bát, mọi giác quan và ý tưởng đều đang ở trạng thái tỉnh táo nhất.", chill: "Cả người em như được sạc đầy pin vậy, tận dụng năng lượng này để làm điều mình thích nha!" },
    "Cự Giải": { vutru: "Kinh Trập — sâu bọ tỉnh giấc, Mộc khí bừng lên mạnh mẽ. Cự Giải vốn nhạy cảm, cảm nhận rõ sức sống đang trỗi dậy khắp nơi.", chill: "Cảm giác tràn đầy sức sống đang lan toả khắp nơi đó, hoà mình vào năng lượng đó đi!" },
    "Sư Tử": { vutru: "Kinh Trập — sâu bọ tỉnh giấc, Mộc khí bừng lên, đang nuôi dưỡng cho Hoả của Sư Tử sắp bùng cháy. Đây là lúc chuẩn bị sẵn sàng.", chill: "Lửa trong em đang được thổi bùng dần rồi đó, chuẩn bị sẵn sàng cho màn trình diễn sắp tới!" },
    "Xử Nữ": { vutru: "Kinh Trập — sâu bọ tỉnh giấc, Mộc khí bừng lên. Xử Nữ vốn tỉ mỉ, đây là lúc bắt tay thực hiện những kế hoạch đã chuẩn bị kỹ lưỡng.", chill: "Kế hoạch chuẩn bị kỹ bao lâu nay giờ là lúc bắt tay thực hiện rồi đó, làm thôi!" },
    "Thiên Bình": { vutru: "Kinh Trập — sâu bọ tỉnh giấc, Mộc khí bừng lên. Thiên Bình vốn cân bằng, sức sống mới giúp tìm lại sự hài hoà sau mùa đông tĩnh lặng.", chill: "Sau mùa đông tĩnh lặng, giờ là lúc tìm lại nhịp sống hài hoà và năng động hơn nha!" },
    "Bọ Cạp": { vutru: "Kinh Trập — sâu bọ tỉnh giấc, Mộc khí bừng lên mạnh mẽ. Bọ Cạp vốn mãnh liệt, đây là lúc chuyển hoá mạnh mẽ nhất trong năm.", chill: "Đây là lúc lột xác mạnh mẽ nhất năm đó, đón nhận sự thay đổi lớn nha!" },
    "Nhân Mã": { vutru: "Kinh Trập — sâu bọ tỉnh giấc, Mộc khí bừng lên. Nhân Mã vốn phóng khoáng, năng lượng mới giúp hành trình thêm phần hào hứng.", chill: "Năng lượng mới đang tiếp sức cho hành trình của em đó, cứ tiến lên phía trước thôi!" },
    "Ma Kết": { vutru: "Kinh Trập — sâu bọ tỉnh giấc, Mộc khí bừng lên thay Thuỷ. Ma Kết vốn kiên trì, đây là lúc thích nghi với nhịp độ nhanh hơn của mùa mới.", chill: "Nhịp độ đang nhanh dần lên rồi đó, bắt kịp và thích nghi theo nha!" },
    "Bảo Bình": { vutru: "Kinh Trập — sâu bọ tỉnh giấc, Mộc khí bừng lên. Bảo Bình vốn sáng tạo, năng lượng mới giúp những ý tưởng táo bạo dễ dàng biến thành hành động.", chill: "Ý tưởng táo bạo giờ dễ biến thành hành động hơn hẳn đó, thử ngay đi!" },
    "Song Ngư": { vutru: "Kinh Trập — sâu bọ tỉnh giấc, Mộc khí bừng lên. Song Ngư vốn mơ mộng, đây là lúc những giấc mơ bắt đầu chuyển hoá thành hiện thực.", chill: "Giấc mơ ấp ủ lâu nay đang có dấu hiệu thành hiện thực rồi đó, tin vào nó nha!" }
  },
  "Xuân Phân": {
    "Bạch Dương": { vutru: "Xuân Phân — ngày đêm bằng nhau, Mộc khí vượng — đúng mùa của Bạch Dương. Đây là thời điểm năng lượng và sự quyết đoán đạt đỉnh cao.", chill: "Đúng mùa của em rồi đó! Quyết định gì khó thì làm ngay lúc này, tỉ lệ thành công đang cao nhất năm!" },
    "Kim Ngưu": { vutru: "Xuân Phân — ngày đêm bằng nhau, Mộc khí vượng. Kim Ngưu vốn thực tế, đây là lúc củng cố những gì đã gieo trồng từ đầu mùa xuân.", chill: "Hạt giống gieo đầu xuân giờ đang lớn đều rồi đó, tiếp tục chăm sóc cẩn thận nha!" },
    "Song Tử": { vutru: "Xuân Phân — ngày đêm bằng nhau, Mộc khí vượng. Song Tử vốn linh hoạt, sự cân bằng giúp chọn lọc được ý tưởng nào đáng theo đuổi nhất.", chill: "Giữa nhiều ý tưởng, giờ là lúc chọn ra cái hay nhất để dồn sức làm đó!" },
    "Cự Giải": { vutru: "Xuân Phân — ngày đêm bằng nhau, Mộc khí vượng. Cự Giải vốn nhạy cảm, sự cân bằng của tiết trời giúp tâm trạng ổn định hơn hẳn.", chill: "Tâm trạng đang ở trạng thái cân bằng đẹp nhất rồi đó, tận hưởng sự bình yên này nha!" },
    "Sư Tử": { vutru: "Xuân Phân — ngày đêm bằng nhau, Mộc khí vượng, đang nuôi dưỡng mạnh cho Hoả sắp bùng lên. Sư Tử vốn rực rỡ, ngọn lửa đang được tiếp thêm sức mạnh.", chill: "Lửa trong em đang được tiếp thêm sức mạnh từng ngày đó, sắp tới lúc bùng cháy thật sự rồi!" },
    "Xử Nữ": { vutru: "Xuân Phân — ngày đêm bằng nhau, Mộc khí vượng. Xử Nữ vốn chỉn chu, sự cân bằng giúp nhìn nhận công việc một cách khách quan, rõ ràng hơn.", chill: "Đầu óc em đang cực kỳ tỉnh táo để đánh giá mọi việc khách quan đó, tận dụng đi!" },
    "Thiên Bình": { vutru: "Xuân Phân — ngày đêm bằng nhau, đúng vào mùa của Thiên Bình. Đây là giai đoạn năng lượng và sự hài hoà đạt đỉnh cao nhất năm.", chill: "Đây chính là sân nhà của em đó! Việc gì quan trọng thì làm ngay lúc này, mọi thứ đang thuận lợi nhất!" },
    "Bọ Cạp": { vutru: "Xuân Phân — ngày đêm bằng nhau, Mộc khí vượng. Bọ Cạp vốn sâu sắc, sự cân bằng giúp nhìn thấu vấn đề mà không bị cảm xúc chi phối quá nhiều.", chill: "Đầu óc em đang tỉnh táo, không bị cảm xúc lấn át, nhìn mọi thứ rõ ràng hơn hẳn!" },
    "Nhân Mã": { vutru: "Xuân Phân — ngày đêm bằng nhau, Mộc khí vượng. Nhân Mã vốn phóng khoáng, sự cân bằng giúp cân đối giữa tự do và trách nhiệm.", chill: "Vừa chơi vừa làm vẫn ổn, cân bằng cả 2 đúng phong cách của em mà!" },
    "Ma Kết": { vutru: "Xuân Phân — ngày đêm bằng nhau, Mộc khí vượng thay Thuỷ. Ma Kết vốn kiên trì, đây là lúc thích nghi hoàn toàn với nhịp độ mùa mới.", chill: "Giờ em đã thích nghi hoàn toàn với nhịp độ mới rồi đó, tự tin tiến lên thôi!" },
    "Bảo Bình": { vutru: "Xuân Phân — ngày đêm bằng nhau, Mộc khí vượng. Bảo Bình vốn khác biệt, sự cân bằng giúp ý tưởng táo bạo trở nên khả thi và dễ thực hiện hơn.", chill: "Ý tưởng điên điên của em giờ có vẻ khả thi hơn nhiều rồi đó, thử làm xem sao!" },
    "Song Ngư": { vutru: "Xuân Phân — ngày đêm bằng nhau, Mộc khí vượng. Song Ngư vốn mơ mộng, sự cân bằng giúp giấc mơ và thực tế xích lại gần nhau.", chill: "Giấc mơ và thực tế đang gần nhau hơn bao giờ hết đó, bắt tay hiện thực hoá nó thôi!" }
  },
  "Thanh Minh": {
    "Bạch Dương": { vutru: "Thanh Minh — trời trong sáng, khí trời thanh khiết, Mộc khí vượng. Bạch Dương vốn thẳng thắn, đây là lúc mọi thứ trở nên rõ ràng, minh bạch hơn.", chill: "Mọi thứ đang rõ ràng hơn bao giờ hết đó, không cần vòng vo, cứ thẳng thắn mà tiến tới!" },
    "Kim Ngưu": { vutru: "Thanh Minh — trời trong sáng, khí trời thanh khiết. Kim Ngưu vốn thực tế, đây là lúc nhìn nhận mọi việc một cách sáng suốt, không bị che mờ.", chill: "Đầu óc em đang sáng suốt hơn hẳn đó, quyết định gì thì đây là lúc tốt để làm!" },
    "Song Tử": { vutru: "Thanh Minh — trời trong sáng, khí trời thanh khiết, Mộc khí vượng. Song Tử vốn nhanh nhạy, sự minh bạch giúp giao tiếp trở nên hiệu quả hơn.", chill: "Nói gì hôm nay cũng dễ được hiểu đúng ý đó, tranh thủ trao đổi những điều quan trọng nha!" },
    "Cự Giải": { vutru: "Thanh Minh — trời trong sáng, khí trời thanh khiết. Cự Giải vốn nhạy cảm, đây là dịp truyền thống để tưởng nhớ và kết nối với gia đình, tổ tiên.", chill: "Đây là lúc thích hợp để nhớ về nguồn cội và trân trọng những người thân yêu nha!" },
    "Sư Tử": { vutru: "Thanh Minh — trời trong sáng, Mộc khí vượng, tiếp tục nuôi dưỡng cho Hoả. Sư Tử vốn rực rỡ, sự trong sáng của tiết trời phản chiếu đúng nội tâm minh bạch.", chill: "Nội tâm em đang trong sáng như trời hôm nay vậy, cứ tự tin thể hiện bản thân thật nha!" },
    "Xử Nữ": { vutru: "Thanh Minh — trời trong sáng, khí trời thanh khiết. Xử Nữ vốn chỉn chu, đây là lúc dọn dẹp lại mọi thứ cho gọn gàng, minh bạch.", chill: "Dọn dẹp không gian sống lẫn đầu óc cho thật gọn gàng đi, sẽ thấy nhẹ nhõm hẳn ra đó!" },
    "Thiên Bình": { vutru: "Thanh Minh — trời trong sáng, Mộc khí vượng, vẫn còn dư âm mùa của Thiên Bình. Sự minh bạch giúp các mối quan hệ trở nên rõ ràng hơn.", chill: "Mối quan hệ nào còn mập mờ thì hôm nay là lúc làm rõ ràng lại đó!" },
    "Bọ Cạp": { vutru: "Thanh Minh — trời trong sáng, khí trời thanh khiết. Bọ Cạp vốn bí ẩn, sự trong sáng của tiết trời giúp những điều giấu kín trở nên rõ ràng hơn.", chill: "Điều gì giấu kín lâu rồi thì hôm nay có thể là lúc phù hợp để làm rõ đó!" },
    "Nhân Mã": { vutru: "Thanh Minh — trời trong sáng, khí trời thanh khiết, Mộc khí vượng. Nhân Mã vốn thẳng thắn, đây là lúc nói thật lòng mình mà không sợ hiểu lầm.", chill: "Nói thật lòng hôm nay sẽ được đón nhận tốt đó, cứ thẳng thắn chia sẻ suy nghĩ của mình!" },
    "Ma Kết": { vutru: "Thanh Minh — trời trong sáng, Mộc khí vượng thay Thuỷ. Ma Kết vốn kiên trì, sự minh bạch giúp nhìn rõ con đường phía trước cần đi.", chill: "Con đường phía trước đang rõ ràng hơn hẳn đó, tự tin bước tiếp thôi!" },
    "Bảo Bình": { vutru: "Thanh Minh — trời trong sáng, khí trời thanh khiết. Bảo Bình vốn sáng tạo, đầu óc minh mẫn giúp ý tưởng trở nên rõ ràng, dễ triển khai hơn.", chill: "Ý tưởng trong đầu em đang rõ ràng hơn hẳn rồi đó, viết ra và bắt tay làm thôi!" },
    "Song Ngư": { vutru: "Thanh Minh — trời trong sáng, Mộc khí vượng. Song Ngư vốn mơ mộng, sự trong sáng giúp phân biệt rõ đâu là mơ, đâu là thực để hành động đúng đắn.", chill: "Giờ em đã phân biệt rõ đâu là mơ đâu là thực rồi đó, hành động dựa trên điều đó nha!" }
  },
  "Cốc Vũ": {
    "Bạch Dương": { vutru: "Cốc Vũ — mưa xuân cuối mùa tưới đẫm đất, giai đoạn chuyển giao sang hành Thổ. Bạch Dương vốn nóng vội, đây là lúc học cách kiên nhẫn chờ đợi.", chill: "Nền móng xây bấy lâu sắp trổ quả rồi, đừng nản ở chặng cuối nha, sắp chạm tới rồi đó!" },
    "Kim Ngưu": { vutru: "Cốc Vũ — mưa xuân cuối mùa, chuyển sang hành Thổ. Kim Ngưu vốn bền bỉ, hành Thổ rất hợp với sự ổn định, chắc chắn của Kim Ngưu.", chill: "Hành Thổ đúng gu của em quá rồi, đây là giai đoạn cực kỳ thuận lợi cho sự ổn định!" },
    "Song Tử": { vutru: "Cốc Vũ — mưa xuân cuối mùa tưới đẫm đất, chuyển hành Thổ. Song Tử vốn linh hoạt, đây là lúc học cách kiên nhẫn hoàn thiện thay vì nhảy sang việc mới.", chill: "Đừng nhảy sang việc mới vội, hoàn thiện nốt việc đang làm dở trước đã nha!" },
    "Cự Giải": { vutru: "Cốc Vũ — mưa xuân cuối mùa, chuyển sang hành Thổ. Cự Giải vốn nhạy cảm, mưa cuối xuân mang lại cảm giác an toàn, được nuôi dưỡng.", chill: "Cảm giác được che chở, an toàn đang bao quanh em đó, tận hưởng sự bình yên này nha!" },
    "Sư Tử": { vutru: "Cốc Vũ — mưa xuân cuối mùa, chuyển hành Thổ, chuẩn bị nhường chỗ hoàn toàn cho Hoả. Sư Tử vốn rực rỡ, đây là những bước chuẩn bị cuối cùng.", chill: "Đây là những bước chuẩn bị cuối cùng trước khi bùng nổ thật sự đó, sắp tới lúc rồi!" },
    "Xử Nữ": { vutru: "Cốc Vũ — mưa xuân cuối mùa, chuyển hành Thổ — rất hợp bản chất tỉ mỉ, thực tế của Xử Nữ. Đây là giai đoạn thuận lợi cho sự ổn định.", chill: "Hành Thổ hợp gu em lắm đó, đây là lúc mọi thứ em xây dựng trở nên vững chắc hơn!" },
    "Thiên Bình": { vutru: "Cốc Vũ — mưa xuân cuối mùa, chuyển sang hành Thổ. Thiên Bình vốn cân bằng, đây là lúc cân đối giữa kết thúc mùa xuân và chuẩn bị đón hè.", chill: "Đứng giữa 2 mùa, đây là lúc hợp để cân nhắc và chuẩn bị cho giai đoạn tiếp theo nha!" },
    "Bọ Cạp": { vutru: "Cốc Vũ — mưa xuân cuối mùa tưới đẫm đất, chuyển hành Thổ. Bọ Cạp vốn sâu sắc, mưa cuối mùa gột rửa những gì còn sót lại từ giai đoạn trước.", chill: "Những điều cũ đang được gột rửa hết rồi đó, sẵn sàng cho 1 chương mới nha!" },
    "Nhân Mã": { vutru: "Cốc Vũ — mưa xuân cuối mùa, chuyển sang hành Thổ. Nhân Mã vốn phóng khoáng, đây là lúc hoàn thiện chặng đường xuân trước khi mùa hè rộng mở hơn.", chill: "Chặng đường mùa xuân sắp hoàn thành rồi đó, ráng về đích rồi mùa hè tha hồ khám phá!" },
    "Ma Kết": { vutru: "Cốc Vũ — mưa xuân cuối mùa, chuyển hành Thổ — rất hợp bản chất bền bỉ của Ma Kết. Đây là giai đoạn củng cố vững chắc nhất.", chill: "Hành Thổ đúng chất em luôn, đây là lúc mọi nỗ lực trở nên vững chắc, khó lay chuyển!" },
    "Bảo Bình": { vutru: "Cốc Vũ — mưa xuân cuối mùa, chuyển sang hành Thổ. Bảo Bình vốn khác biệt, đây là lúc biến những ý tưởng bay bổng thành nền tảng thực tế.", chill: "Ý tưởng bay bổng giờ cần 1 nền tảng thực tế để đứng vững, tập trung vào đó nha!" },
    "Song Ngư": { vutru: "Cốc Vũ — mưa xuân cuối mùa tưới đẫm đất, chuyển hành Thổ. Song Ngư vốn mơ mộng, mưa cuối xuân là lúc đẹp để hoàn thiện những dự định đã ấp ủ.", chill: "Mưa cuối xuân đẹp lắm, tận dụng cảm hứng này để hoàn thiện điều em đang ấp ủ nha!" }
  },
  "Lập Hạ": {
    "Bạch Dương": { vutru: "Lập Hạ — mùa Hạ bắt đầu, hành Hoả mới lên — đúng chất năng động của Bạch Dương. Đây là lúc năng lượng bắt đầu bùng nổ mạnh mẽ.", chill: "Đúng gu của em quá rồi! Mùa lửa bắt đầu, năng lượng em cũng đang tăng tốc theo đó!" },
    "Kim Ngưu": { vutru: "Lập Hạ — mùa Hạ bắt đầu, hành Hoả mới lên thay Mộc. Kim Ngưu vốn ổn định, cần thích nghi dần với nhịp độ nhanh hơn của mùa hè.", chill: "Nhịp độ đang nhanh dần lên rồi đó, từ từ thích nghi, không cần vội vàng nha!" },
    "Song Tử": { vutru: "Lập Hạ — mùa Hạ bắt đầu, hành Hoả mới lên. Song Tử vốn năng động, mùa hè mang tới nguồn năng lượng dồi dào cho những ý tưởng mới.", chill: "Năng lượng mùa hè đang tiếp sức cho đầu óc năng động của em đó, tận dụng đi!" },
    "Cự Giải": { vutru: "Lập Hạ — mùa Hạ bắt đầu, hành Hoả mới lên — đúng mùa của Cự Giải theo lịch dương. Cảm xúc và sự gắn kết đang ở giai đoạn ấm áp nhất.", chill: "Đúng mùa của em rồi đó! Dành thời gian cho những người thân yêu trong giai đoạn ấm áp này nha!" },
    "Sư Tử": { vutru: "Lập Hạ — mùa Hạ bắt đầu, hành Hoả mới lên — chính là nguyên tố của Sư Tử. Đây là lúc ngọn lửa bắt đầu được thắp sáng thực sự.", chill: "Mùa của em đang tới rồi đó! Ngọn lửa trong em bắt đầu được thắp lên, chuẩn bị toả sáng thôi!" },
    "Xử Nữ": { vutru: "Lập Hạ — mùa Hạ bắt đầu, hành Hoả mới lên thay Mộc. Xử Nữ vốn chỉn chu, đây là lúc điều chỉnh lại kế hoạch cho phù hợp với nhịp độ mới.", chill: "Nhịp độ mới cần kế hoạch mới, điều chỉnh lại 1 chút cho phù hợp nha!" },
    "Thiên Bình": { vutru: "Lập Hạ — mùa Hạ bắt đầu, hành Hoả mới lên. Thiên Bình vốn cân bằng, cần giữ nhịp giữa năng lượng mùa hè và sự điềm tĩnh vốn có.", chill: "Năng lượng mùa hè lên cao nhưng vẫn giữ được sự điềm tĩnh của em nha, cân bằng là chìa khoá!" },
    "Bọ Cạp": { vutru: "Lập Hạ — mùa Hạ bắt đầu, hành Hoả mới lên. Bọ Cạp vốn mãnh liệt, năng lượng Hoả mới cộng hưởng với sự mãnh liệt sẵn có, tạo nên sức mạnh lớn.", chill: "Năng lượng đang cộng hưởng mạnh trong em đó, dùng nó cho điều thật sự quan trọng nha!" },
    "Nhân Mã": { vutru: "Lập Hạ — mùa Hạ bắt đầu, hành Hoả mới lên. Nhân Mã vốn phóng khoáng, mùa hè mở ra nhiều cơ hội cho những chuyến phiêu lưu mới.", chill: "Mùa hè đang mở ra cơ hội cho những chuyến đi mới đó, lên kế hoạch phiêu lưu thôi!" },
    "Ma Kết": { vutru: "Lập Hạ — mùa Hạ bắt đầu, hành Hoả mới lên thay Mộc. Ma Kết vốn kiên trì, cần thích nghi với năng lượng sôi động hơn của mùa mới.", chill: "Mùa mới năng lượng cao hơn hẳn đó, bắt nhịp dần theo nha, không cần gấp gáp!" },
    "Bảo Bình": { vutru: "Lập Hạ — mùa Hạ bắt đầu, hành Hoả mới lên. Bảo Bình vốn sáng tạo, năng lượng mới giúp những ý tưởng táo bạo có thêm động lực triển khai.", chill: "Năng lượng mùa hè đang tiếp thêm động lực cho ý tưởng táo bạo của em đó, làm liền đi!" },
    "Song Ngư": { vutru: "Lập Hạ — mùa Hạ bắt đầu, hành Hoả mới lên thay Mộc. Song Ngư vốn mơ mộng, cần chú ý cân bằng giữa sự sôi động bên ngoài và tâm hồn tĩnh lặng.", chill: "Bên ngoài sôi động nhưng đừng quên dành thời gian cho tâm hồn tĩnh lặng của mình nha!" }
  },
  "Tiểu Mãn": {
    "Bạch Dương": { vutru: "Tiểu Mãn — lúa bắt đầu chắc hạt nhưng chưa chín hẳn, hành Hoả tiếp tục lên. Bạch Dương vốn nóng vội, đây là lúc đẩy thêm 1 chút nữa là trọn vẹn.", chill: "Đừng dừng lại ở 80% nha, đẩy thêm 1 chút xíu nữa là full combo rồi, đứng lên đi tiếp thôi!" },
    "Kim Ngưu": { vutru: "Tiểu Mãn — lúa chắc hạt nhưng chưa chín, giai đoạn gần được. Kim Ngưu vốn kiên nhẫn, đây là lúc phù hợp nhất để chờ đợi thành quả chín muồi.", chill: "Gần được rồi đó, kiên nhẫn thêm chút xíu nữa thôi, đừng vội hái non nha!" },
    "Song Tử": { vutru: "Tiểu Mãn — lúa chắc hạt nhưng chưa chín, hành Hoả tiếp tục lên. Song Tử vốn nóng lòng muốn xem kết quả, cần thêm chút kiên nhẫn cho việc đang dở.", chill: "Sắp xong rồi mà, kiên nhẫn thêm xíu là thấy kết quả liền, đừng bỏ cuộc giữa chừng!" },
    "Cự Giải": { vutru: "Tiểu Mãn — lúa chắc hạt nhưng chưa chín. Cự Giải vốn nhạy cảm, giai đoạn gần được này dễ khiến sốt ruột, cần giữ tâm lý ổn định.", chill: "Sắp tới đích rồi, đừng để sốt ruột làm mất bình tĩnh nha, giữ vững tâm lý là qua hết!" },
    "Sư Tử": { vutru: "Tiểu Mãn — lúa chắc hạt nhưng chưa chín, hành Hoả tiếp tục lên mạnh — đúng đà của Sư Tử. Ngọn lửa đang cháy dần mạnh hơn mỗi ngày.", chill: "Lửa trong em đang cháy mạnh dần lên từng ngày đó, sắp tới lúc rực rỡ nhất rồi!" },
    "Xử Nữ": { vutru: "Tiểu Mãn — lúa chắc hạt nhưng chưa chín. Xử Nữ vốn cầu toàn, đây là lúc chấp nhận rằng mọi thứ cần thời gian để hoàn thiện, không thể vội.", chill: "Chưa hoàn hảo 100% cũng không sao, đang trên đường tới rồi, kiên nhẫn thêm chút nha!" },
    "Thiên Bình": { vutru: "Tiểu Mãn — lúa chắc hạt nhưng chưa chín, hành Hoả tiếp tục lên. Thiên Bình vốn cân bằng, đây là lúc cân đối giữa kỳ vọng và thực tế.", chill: "Kỳ vọng và thực tế đang dần khớp nhau rồi đó, kiên nhẫn thêm 1 chút là trọn vẹn!" },
    "Bọ Cạp": { vutru: "Tiểu Mãn — lúa chắc hạt nhưng chưa chín. Bọ Cạp vốn quyết liệt, giai đoạn chờ đợi này là bài test cho sự kiên nhẫn vốn không phải sở trường.", chill: "Chờ đợi không phải sở trường của em nhưng lần này ráng thêm chút, sắp có kết quả rồi!" },
    "Nhân Mã": { vutru: "Tiểu Mãn — lúa chắc hạt nhưng chưa chín, hành Hoả tiếp tục lên. Nhân Mã vốn nóng lòng khám phá, cần kiên nhẫn hoàn thành chặng đường đang đi trước khi mở chặng mới.", chill: "Đường đang đi sắp xong rồi, hoàn thành nốt trước khi mở ra hành trình mới nha!" },
    "Ma Kết": { vutru: "Tiểu Mãn — lúa chắc hạt nhưng chưa chín. Ma Kết vốn kiên trì bậc nhất, đây chính là thế mạnh giúp bạn vượt qua giai đoạn chờ đợi dễ dàng.", chill: "Kiên nhẫn là thế mạnh của em mà, giai đoạn chờ đợi này chẳng là gì với em cả!" },
    "Bảo Bình": { vutru: "Tiểu Mãn — lúa chắc hạt nhưng chưa chín, hành Hoả tiếp tục lên. Bảo Bình vốn nóng lòng thực hiện ý tưởng mới, cần hoàn thiện cái cũ trước.", chill: "Ý tưởng mới thì để dành sau, hoàn thiện nốt cái đang làm dở đã nha!" },
    "Song Ngư": { vutru: "Tiểu Mãn — lúa chắc hạt nhưng chưa chín. Song Ngư vốn mơ mộng, giai đoạn gần được là lúc để tin tưởng vào quá trình hơn là kết quả tức thì.", chill: "Tin vào quá trình đi, không cần vội thấy kết quả liền, mọi thứ đang đi đúng hướng!" }
  },
  "Mang Chủng": {
    "Bạch Dương": { vutru: "Mang Chủng — mùa gieo hạt cho vụ mới, hành Hoả vượng. Bạch Dương vốn năng động, đây là lúc gieo thêm những dự định mới bên cạnh việc đang làm.", chill: "Trong lúc chờ việc cũ chín, tranh thủ gieo thêm hạt giống mới cho tương lai nha!" },
    "Kim Ngưu": { vutru: "Mang Chủng — mùa gieo hạt, hành Hoả vượng. Kim Ngưu vốn thực tế, đây là lúc cân đối giữa chăm sóc thành quả cũ và gieo trồng cái mới.", chill: "Vừa chăm cái cũ vừa gieo cái mới, cân bằng cả 2 đúng phong cách chắc chắn của em!" },
    "Song Tử": { vutru: "Mang Chủng — mùa gieo hạt, hành Hoả vượng. Song Tử vốn thích cái mới, đây là mùa lý tưởng để thử nghiệm nhiều ý tưởng cùng lúc.", chill: "Mùa này hợp để thử nhiều thứ cùng lúc đó, đúng sở trường đa nhiệm của em!" },
    "Cự Giải": { vutru: "Mang Chủng — mùa gieo hạt, hành Hoả vượng. Cự Giải vốn chăm chút, đây là lúc vun đắp cho những mối quan hệ như đang chăm sóc hạt giống.", chill: "Chăm sóc mối quan hệ cũng như chăm hạt giống vậy, kiên nhẫn và đều đặn là sẽ nở hoa!" },
    "Sư Tử": { vutru: "Mang Chủng — mùa gieo hạt, hành Hoả vượng — gần tới đỉnh điểm của Sư Tử. Ngọn lửa đang cháy ngày càng mạnh mẽ hơn.", chill: "Lửa trong em đang cháy càng lúc càng mạnh đó, sắp tới đỉnh cao rồi, chuẩn bị toả sáng!" },
    "Xử Nữ": { vutru: "Mang Chủng — mùa gieo hạt, hành Hoả vượng. Xử Nữ vốn tỉ mỉ, đây là lúc chọn lọc kỹ hạt giống nào đáng gieo trồng nhất trong nhiều lựa chọn.", chill: "Nhiều lựa chọn quá thì chọn kỹ cái nào đáng đầu tư công sức nhất thôi nha!" },
    "Thiên Bình": { vutru: "Mang Chủng — mùa gieo hạt, hành Hoả vượng. Thiên Bình vốn cân bằng, đây là lúc cân đối giữa nhiều dự định để không ôm đồm quá sức.", chill: "Đừng ôm đồm quá nhiều việc cùng lúc, chọn lọc và cân bằng là chìa khoá đó!" },
    "Bọ Cạp": { vutru: "Mang Chủng — mùa gieo hạt, hành Hoả vượng. Bọ Cạp vốn quyết liệt, khi đã chọn gieo trồng điều gì thì dồn hết tâm huyết vào đó.", chill: "Đã chọn rồi thì dồn hết tâm huyết vào thôi, đúng chất quyết liệt của em!" },
    "Nhân Mã": { vutru: "Mang Chủng — mùa gieo hạt, hành Hoả vượng. Nhân Mã vốn phóng khoáng, đây là lúc gieo hạt cho những giấc mơ lớn, không giới hạn bản thân.", chill: "Mơ lớn thì gieo hạt lớn luôn, đừng giới hạn bản thân trong khuôn khổ nào cả!" },
    "Ma Kết": { vutru: "Mang Chủng — mùa gieo hạt, hành Hoả vượng thay Mộc. Ma Kết vốn kiên trì, đây là lúc gieo hạt cho những kế hoạch dài hạn, bền vững.", chill: "Gieo hạt cho kế hoạch dài hạn đi, đúng gu bền vững của em luôn!" },
    "Bảo Bình": { vutru: "Mang Chủng — mùa gieo hạt, hành Hoả vượng. Bảo Bình vốn khác biệt, đây là lúc gieo những hạt giống ý tưởng chưa ai từng nghĩ tới.", chill: "Gieo hạt cho những ý tưởng chưa ai nghĩ tới đi, đúng chất độc lạ của em!" },
    "Song Ngư": { vutru: "Mang Chủng — mùa gieo hạt, hành Hoả vượng. Song Ngư vốn mơ mộng, đây là lúc gieo hạt cho những dự định gắn liền với đam mê nghệ thuật, sáng tạo.", chill: "Gieo hạt cho đam mê nghệ thuật của em đi, mùa này rất hợp để bắt đầu!" }
  },
  "Hạ Chí": {
    "Bạch Dương": { vutru: "Hạ Chí — ngày dài nhất năm, Hoả khí đỉnh điểm. Bạch Dương vốn là lửa của lửa, năng lượng hôm nay gần như không có giới hạn trên.", chill: "Full pin 100% đó chiến thần 🔥 Nhưng nhớ đừng đốt sạch trong 1 ngày, để dành chút cho ngày mai nha!" },
    "Kim Ngưu": { vutru: "Hạ Chí — ngày dài nhất năm, Hoả khí đỉnh điểm. Kim Ngưu vốn điềm tĩnh, hôm nay có thể thấy năng lượng dâng cao hơn thường lệ.", chill: "Năng lượng đang lên cao hơn bình thường đó, tận dụng để làm việc mình thích nha!" },
    "Song Tử": { vutru: "Hạ Chí — ngày dài nhất năm, Hoả khí đỉnh điểm. Song Tử vốn nhanh nhẹn, hôm nay đầu óc hoạt động ở tốc độ cao nhất năm.", chill: "Não đang chạy full tốc độ nhất năm đó, tận dụng để giải quyết việc khó nha!" },
    "Cự Giải": { vutru: "Hạ Chí — ngày dài nhất năm, Hoả khí đỉnh điểm. Cự Giải vốn nhạy cảm, ngày dài mang tới nhiều thời gian hơn để kết nối với người thân.", chill: "Ngày dài hơn là cơ hội để dành nhiều thời gian hơn cho người thương yêu đó!" },
    "Sư Tử": { vutru: "Hạ Chí — ngày dài nhất năm, Hoả khí đỉnh điểm — đúng đỉnh cao của Sư Tử sắp tới. Ngọn lửa đang chuẩn bị bùng cháy mạnh mẽ nhất.", chill: "Sắp tới đỉnh cao của em rồi đó! Chuẩn bị tinh thần để toả sáng rực rỡ nhất năm!" },
    "Xử Nữ": { vutru: "Hạ Chí — ngày dài nhất năm, Hoả khí đỉnh điểm. Xử Nữ vốn tỉ mỉ, ngày dài cho phép hoàn thành được nhiều việc chi tiết hơn.", chill: "Ngày dài hơn là thêm thời gian để em hoàn thiện mọi chi tiết đó, tận dụng đi!" },
    "Thiên Bình": { vutru: "Hạ Chí — ngày dài nhất năm, Hoả khí đỉnh điểm. Thiên Bình vốn cân bằng, cần chú ý cân đối giữa năng lượng cao và nhu cầu nghỉ ngơi.", chill: "Năng lượng cao nhưng đừng quên nghỉ ngơi đủ nha, cân bằng vẫn là chìa khoá!" },
    "Bọ Cạp": { vutru: "Hạ Chí — ngày dài nhất năm, Hoả khí đỉnh điểm. Bọ Cạp vốn mãnh liệt, hôm nay cảm xúc và năng lượng đều đang ở mức cao trào.", chill: "Cảm xúc mạnh hôm nay là bình thường thôi, hướng nó vào việc có ích nha!" },
    "Nhân Mã": { vutru: "Hạ Chí — ngày dài nhất năm, Hoả khí đỉnh điểm. Nhân Mã vốn phóng khoáng, ngày dài là cơ hội tuyệt vời cho những hoạt động ngoài trời.", chill: "Ngày dài nhất năm, ra ngoài trời tận hưởng và khám phá thôi, đúng gu của em mà!" },
    "Ma Kết": { vutru: "Hạ Chí — ngày dài nhất năm, Hoả khí đỉnh điểm thay Mộc. Ma Kết vốn kiên trì, tiết trời nóng nực tiếp thêm quyết tâm cho mục tiêu đang theo đuổi.", chill: "Nắng chiếu vào là quyết tâm em cũng cháy theo luôn á, đẩy nốt việc đang dang dở nha!" },
    "Bảo Bình": { vutru: "Hạ Chí — ngày dài nhất năm, Hoả khí đỉnh điểm. Bảo Bình vốn sáng tạo, ngày dài mang lại nhiều thời gian hơn để hiện thực hoá ý tưởng.", chill: "Nhiều thời gian hơn để biến ý tưởng thành hiện thực đó, tận dụng thời gian này nha!" },
    "Song Ngư": { vutru: "Hạ Chí — ngày dài nhất năm, Hoả khí đỉnh điểm. Song Ngư vốn mơ mộng, cần chú ý cân bằng giữa năng lượng sôi động bên ngoài và nhu cầu nghỉ ngơi.", chill: "Ngày dài nhưng đừng quên nghỉ ngơi đủ giấc, sức khoẻ vẫn quan trọng nhất nha!" }
  },
  "Tiểu Thử": {
    "Bạch Dương": { vutru: "Tiểu Thử — nắng bắt đầu oi nhẹ, hành Hoả tiếp tục vượng, chuẩn bị cho đỉnh điểm Đại Thử sắp tới. Bạch Dương vốn năng động, cần chuẩn bị sức bền cho giai đoạn nóng nhất sắp tới.", chill: "Cái nóng thật sự sắp tới rồi đó, dưỡng sức 1 chút trước khi bung hết cỡ vào đợt cao điểm nha!" },
    "Kim Ngưu": { vutru: "Tiểu Thử — nắng bắt đầu oi nhẹ, hành Hoả tiếp tục vượng. Kim Ngưu vốn ổn định, đây là lúc chuẩn bị kỹ càng trước giai đoạn nóng nhất năm.", chill: "Chuẩn bị kỹ càng trước khi bước vào giai đoạn cao điểm sắp tới nha, đúng phong cách cẩn thận của em!" },
    "Song Tử": { vutru: "Tiểu Thử — nắng bắt đầu oi nhẹ, hành Hoả tiếp tục vượng. Song Tử vốn nhanh nhạy, cảm nhận rõ không khí đang nóng dần lên từng ngày.", chill: "Không khí đang nóng dần lên rồi đó, chuẩn bị tinh thần cho giai đoạn sôi động sắp tới!" },
    "Cự Giải": { vutru: "Tiểu Thử — nắng bắt đầu oi nhẹ, hành Hoả tiếp tục vượng. Cự Giải vốn nhạy cảm, cần chú ý giữ gìn sức khoẻ khi thời tiết bắt đầu oi bức.", chill: "Trời bắt đầu oi rồi đó, uống đủ nước và giữ gìn sức khoẻ nha!" },
    "Sư Tử": { vutru: "Tiểu Thử — nắng bắt đầu oi nhẹ, hành Hoả tiếp tục vượng, sắp chạm đỉnh điểm của Sư Tử. Ngọn lửa đang cháy mạnh dần, chuẩn bị bùng nổ.", chill: "Sắp chạm đỉnh mùa của em rồi đó! Lửa đang cháy mạnh dần, chuẩn bị bùng nổ thật sự nha!" },
    "Xử Nữ": { vutru: "Tiểu Thử — nắng bắt đầu oi nhẹ, hành Hoả tiếp tục vượng. Xử Nữ vốn chỉn chu, đây là lúc chuẩn bị kỹ lưỡng cho giai đoạn cao điểm phía trước.", chill: "Chuẩn bị kỹ lưỡng trước giai đoạn cao điểm nha, mọi chi tiết đều quan trọng lúc này!" },
    "Thiên Bình": { vutru: "Tiểu Thử — nắng bắt đầu oi nhẹ, hành Hoả tiếp tục vượng. Thiên Bình vốn cân bằng, cần điều chỉnh dần nhịp sống cho phù hợp với cái nóng sắp tới.", chill: "Điều chỉnh nhịp sống dần cho hợp với cái nóng sắp tới nha, đừng để sốc nhiệt cả nghĩa đen lẫn nghĩa bóng!" },
    "Bọ Cạp": { vutru: "Tiểu Thử — nắng bắt đầu oi nhẹ, hành Hoả tiếp tục vượng. Bọ Cạp vốn mãnh liệt, cái nóng dần tăng cộng hưởng với năng lượng nội tại vốn có.", chill: "Năng lượng đang tích tụ dần trong em đó, chuẩn bị cho đợt bùng nổ sắp tới nha!" },
    "Nhân Mã": { vutru: "Tiểu Thử — nắng bắt đầu oi nhẹ, hành Hoả tiếp tục vượng. Nhân Mã vốn phóng khoáng, đây là lúc lên kế hoạch cho những hoạt động mùa hè sôi động.", chill: "Kế hoạch mùa hè sôi động thì lên ngay từ bây giờ đi, sắp tới lúc thực hiện rồi!" },
    "Ma Kết": { vutru: "Tiểu Thử — nắng bắt đầu oi nhẹ, hành Hoả tiếp tục vượng thay Mộc. Ma Kết vốn kiên trì, cần chuẩn bị sức bền cho giai đoạn nóng nhất năm sắp tới.", chill: "Dưỡng sức bền trước khi bước vào giai đoạn cao điểm nha, đúng chất bền bỉ của em!" },
    "Bảo Bình": { vutru: "Tiểu Thử — nắng bắt đầu oi nhẹ, hành Hoả tiếp tục vượng. Bảo Bình vốn sáng tạo, cái nóng dần tăng kích thích những ý tưởng táo bạo hơn.", chill: "Trời nóng dần lên mà đầu em cũng nóng ý tưởng theo đó, ghi lại hết những ý hay ho nha!" },
    "Song Ngư": { vutru: "Tiểu Thử — nắng bắt đầu oi nhẹ, hành Hoả tiếp tục vượng. Song Ngư vốn mơ mộng, cần chú ý cân bằng năng lượng khi thời tiết bắt đầu oi bức.", chill: "Trời oi dễ làm mệt người đó, giữ gìn sức khoẻ và năng lượng cho giai đoạn cao điểm sắp tới nha!" }
  }
};
